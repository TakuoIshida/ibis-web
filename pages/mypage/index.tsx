...
const Index = () => {
  ...
  return (
    <>
      ...
      {userInfo?.photoURL ? (
        <Avatar alt="user photo" src={userInfo.photoURL} />
      ) : (
        <AccountCircle />
      )}
          ...
          return (
            <div className={styles.row}>
              ...
              {idx == 0 ? (
                ...
                //   選択されたサービスの枠を囲う
                <div
                  className={idx == selectedGradeId - 1 ? styles.selected : ""}
                >
                  <Card key={idx} className={styles.card}>
      ...
      <Button
        ...
        onClick={() => gradeChangeRequest(selectedGradeId)}
      >
        {" "}
        変更する
      </Button>
      <Button
        ...
        onClick={() => stopSubscription(selectedGradeId)}
      >
        {" "}
        有料会員をやめる
      </Button>
